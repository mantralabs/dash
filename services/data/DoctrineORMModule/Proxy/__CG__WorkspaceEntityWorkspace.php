...
namespace DoctrineORMModule\Proxy\__CG__\Workspace\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Workspace extends \Workspace\Entity\Workspace implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'workspace_name', 'inputFilter', 'rawdata');
        }
