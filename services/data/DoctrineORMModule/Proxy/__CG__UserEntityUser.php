...
class User extends \User\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'phone', 'photo', 'designation', 'password', 'role', 'email', 'hash', 'inputFilter', 'rawdata');
        }

        return array('__isInitialized__', 'id', 'name', 'phone', 'photo', 'designation', 'password', 'email', 'hash', 'inputFilter', 'rawdata');
    }
    ...
    public function getLoginInputFilter($em)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLoginInputFilter', array($em));

        return parent::getLoginInputFilter($em);
    }
    ...
    public function validateLogin($em = NULL, $throwException = true)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'validateLogin', array($em, $throwException));

        return parent::validateLogin($em, $throwException);
    }
